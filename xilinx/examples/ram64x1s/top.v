...
////////////////////////////////////////////////////// ram control
	...
	always @ (posedge clk) addr <= {cnt_led[2:0], 3'd0};
//	always @ (posedge clk) addr <= {3'd0, cnt_led[2:0]};				// for sim
...
/*			
			begin
				if (flag_cnt_led) 
					begin
						cnt_ramaddr <= cnt_ramaddr + 3'd1;
						addr <=	{cnt_ramaddr, 3'd0};
						wren <= 1'b1;
					end
				else
					begin
...
*/
    RAM64X1S #(
            .INIT(64'h0000_1000_2000_3000)  // Initial contents of RAM
        ) RAM64X1S_inst (
