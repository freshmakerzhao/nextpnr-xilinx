...
export ARCH_BIN=/home/liguolong/gitlab-eda/nextpnr-xilinx-dram/nextpnr-xilinx/xilinx/xc7a100t.bin
export DBROOT=/home/liguolong/gitlab-eda/nextpnr-xilinx-dram/nextpnr-xilinx/xilinx/external/prjxray-db/artix7

export PART=xc7a100tfgg484-2
...
$YOSYS -p "synth_xilinx -flatten -nowidelut -abc9 -arch xc7 -top top; write_json synth.json; show -format dot -prefix synth1" ../top_100t.v
